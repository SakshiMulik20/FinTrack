...
def send_expense_report(to_email, user_name, prediction):
    ...
    for cat, amount in categories:
        ...
        <tr>
            ...
            <td style="padding:8px 16px; border-bottom:1px solid #f0f0f0; text-align:right; color:#e74c3c;">Rs.{amount:,.2f}</td>
        </tr>'''
    ...
    <div style="font-family:Arial,sans-serif; max-width:600px; margin:0 auto; background:#f8f9fa; padding:20px;">
        ...
        <div style="background:white; padding:24px; border-radius:0 0 12px 12px;">
            ...
            <div style="background:#fff3cd; border-radius:8px; padding:16px; text-align:center; margin:16px 0;">
                ...
                <h2 style="margin:8px 0 0; color:#e74c3c;">Rs.{total:,.2f}</h2>
            </div>
            ...
            <div style="background:#f8f9fa; border-radius:8px; padding:16px; margin:16px 0;">
                <table style="width:100%; border-collapse:collapse;">
                    <tr>
                        ...
                        <td style="padding:6px 0; text-align:right; font-weight:bold; color:#333;">{category}</td>
                    </tr>
                    <tr>
                        <td style="padding:6px 0; color:#888;">Budget Limit</td>
                        <td style="padding:6px 0; text-align:right; color:#333;">Rs.{limit:,.2f}</td>
                    </tr>
                    <tr>
                        <td style="padding:6px 0; color:#888;">Amount Spent</td>
                        <td style="padding:6px 0; text-align:right; font-weight:bold; color:{color};">Rs.{spent:,.2f}</td>
                    </tr>
                    <tr>
                        <td style="padding:6px 0; color:#888;">Remaining</td>
                        <td style="padding:6px 0; text-align:right; color:#27ae60;">Rs.{remaining:,.2f}</td>
                    </tr>
                </table>
            </div>
